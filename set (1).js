...
module.exports = { session: process.env.SESSION_ID || 'jinwiil',
    ...
    URL: process.env.URL || "https://files.catbox.moe/lgt88z.jpg",  
    ...
    AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || 'viewed by Jinvon-md',   
    AUTO_STATUS_REPLY: process.env.AUTO_STATUS_REPLY || 'no',
    AUTOBIO: process.env.AUTOBIO || 'yes',       
    ANTICALL_MSG : process.env.ANTICALL_MESSAGE || '',             
    GURL: process.env.GURL  || "https://whatsapp.com/channel/0029VaxZbeSDTkJwBgUb9u3N",
    WEBSITE :process.env.GURL || "https://whatsapp.com/channel/0029VaxZbeSDTkJwBgUb9u3N",
    CAPTION : process.env.CAPTION || "JINVON-MD",
    BOT : process.env.BOT_NAME || 'JINVON-MD',
